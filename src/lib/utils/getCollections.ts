...
export type TCollection = 'docs' | 'pages' | 'posts'
...
/**
 * Fetches all posts from the 'posts' collection, with optional draft and limit parameters.
 *
 * @param draft - Whether to include draft posts (default: false).
 * @param limit - Maximum number of results to fetch (default: 1000).
 * @returns The result of the Payload find query for posts.
 */
...
/**
 * Fetches the latest 10 published posts from the 'posts' collection.
 *
 * @returns The result of the Payload find query for the latest 10 published posts, including selected fields.
 */
